                ...
                <ul>
                    ...
                    <a href={'/contacts'}>
                        ...
                        <li>
                            ...
                            <div className="li--name">Contact</div>
                        </li>
                    </a>
                    <a href={'/skills'}>
                        <li>
                            ...
                            <div className="li--name">Skills</div>
                        </li>
                    </a>
                    <a href={'/projects'}>
                        <li>
                            ...
                            <div className="li--name">Projects</div>
                        </li>
                    </a>
                    ...
                    <li>
                        ...
                        <div className="li--name">Sobre</div>
                    </li>
                    ...
                    <a href={'/suggestions'}>
                        <li>
                            ...
                            <div className="li--name">Sugestões</div>
                        </li>
                    </a>
                </ul>
            </div>
